  ...
  build:
    ...
    - name: Get dependencies
      ...
      run: |
        ...
        sudo apt-get -qq install -y --allow-unauthenticated mysql-server mysql-client make unzip g++ etcd-client etcd-server curl git wget eatmydata xz-utils libncurses6
