  ...
  test:
    ...
    - name: Get dependencies
      ...
      run: |
        ...
        # Get MySQL GPG key directly from Ubuntu keyserver
        sudo gpg --homedir /tmp --no-default-keyring --keyring /etc/apt/trusted.gpg.d/mysql.gpg --keyserver keyserver.ubuntu.com --recv-keys B7B3B788A8D3785C
