  ...
  build:
    ...
    - name: Get dependencies
      ...
      run: |
        ...
        # Install everything else we need, and configure
        sudo apt-get -qq install -y --allow-unauthenticated mysql-server mysql-shell mysql-client make unzip g++ etcd-client etcd-server curl git wget eatmydata xz-utils libncurses6
