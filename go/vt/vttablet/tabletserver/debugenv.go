...
func handlePost(tsv *TabletServer, w http.ResponseWriter, r *http.Request) {
	...
	case "LoadshedEnqueueAdvanceProbability":
		err = setFloat64Val(func(v float64) { tsv.Config().LoadshedEnqueueAdvanceProbability = v })
...
func getVars(tsv *TabletServer) []envValue {
	...
	vars = addVar(vars, "LoadshedEnqueueAdvanceProbability", func() float64 { return tsv.Config().LoadshedEnqueueAdvanceProbability })
