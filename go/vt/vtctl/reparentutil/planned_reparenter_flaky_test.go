...
func TestPlannedReparenterStats(t *testing.T) {
	...
	require.EqualValues(t, map[string]int64{"All": 1, "PlannedReparentShard.testkeyspace.-.success": 1}, reparentShardOpTimings.Counts())
	...
	require.EqualValues(t, map[string]int64{"All": 2, "PlannedReparentShard.testkeyspace.-.success": 1, "PlannedReparentShard.testkeyspace.-.failure": 1}, reparentShardOpTimings.Counts())
}
