...
func TestEmergencyReparenterStats(t *testing.T) {
	...
	require.EqualValues(t, map[string]int64{"All": 1, "EmergencyReparentShard.testkeyspace.-.success": 1}, reparentShardOpTimings.Counts())
	...
	require.EqualValues(t, map[string]int64{"All": 2, "EmergencyReparentShard.testkeyspace.-.success": 1, "EmergencyReparentShard.testkeyspace.-.failure": 1}, reparentShardOpTimings.Counts())
}
