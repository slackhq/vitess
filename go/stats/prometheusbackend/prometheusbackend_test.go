...
func TestPrometheusTimings(t *testing.T) {
	...
	s = append(s, fmt.Sprintf("%s_%s_bucket{category=\"%s\",le=\"0.0016\"} %d", namespace, name, cats[0], 0))
	s = append(s, fmt.Sprintf("%s_%s_bucket{category=\"%s\",le=\"0.0025\"} %d", namespace, name, cats[0], 0))
	s = append(s, fmt.Sprintf("%s_%s_bucket{category=\"%s\",le=\"0.004\"} %d", namespace, name, cats[0], 0))
	s = append(s, fmt.Sprintf("%s_%s_bucket{category=\"%s\",le=\"0.0063\"} %d", namespace, name, cats[0], 0))
	s = append(s, fmt.Sprintf("%s_%s_bucket{category=\"%s\",le=\"0.01\"} %d", namespace, name, cats[0], 0))
	s = append(s, fmt.Sprintf("%s_%s_bucket{category=\"%s\",le=\"0.016\"} %d", namespace, name, cats[0], 0))
	s = append(s, fmt.Sprintf("%s_%s_bucket{category=\"%s\",le=\"0.025\"} %d", namespace, name, cats[0], 0))
	s = append(s, fmt.Sprintf("%s_%s_bucket{category=\"%s\",le=\"0.04\"} %d", namespace, name, cats[0], 1))
	s = append(s, fmt.Sprintf("%s_%s_bucket{category=\"%s\",le=\"0.063\"} %d", namespace, name, cats[0], 1))
	s = append(s, fmt.Sprintf("%s_%s_bucket{category=\"%s\",le=\"0.1\"} %d", namespace, name, cats[0], 1))
	s = append(s, fmt.Sprintf("%s_%s_bucket{category=\"%s\",le=\"0.16\"} %d", namespace, name, cats[0], 1))
	s = append(s, fmt.Sprintf("%s_%s_bucket{category=\"%s\",le=\"0.25\"} %d", namespace, name, cats[0], 2))
	s = append(s, fmt.Sprintf("%s_%s_bucket{category=\"%s\",le=\"0.4\"} %d", namespace, name, cats[0], 2))
	s = append(s, fmt.Sprintf("%s_%s_bucket{category=\"%s\",le=\"0.63\"} %d", namespace, name, cats[0], 2))
	s = append(s, fmt.Sprintf("%s_%s_bucket{category=\"%s\",le=\"1\"} %d", namespace, name, cats[0], 3))
	s = append(s, fmt.Sprintf("%s_%s_bucket{category=\"%s\",le=\"1.6\"} %d", namespace, name, cats[0], 3))
	s = append(s, fmt.Sprintf("%s_%s_bucket{category=\"%s\",le=\"2.5\"} %d", namespace, name, cats[0], 3))
	s = append(s, fmt.Sprintf("%s_%s_bucket{category=\"%s\",le=\"4\"} %d", namespace, name, cats[0], 3))
	s = append(s, fmt.Sprintf("%s_%s_bucket{category=\"%s\",le=\"6.3\"} %d", namespace, name, cats[0], 3))
...
func TestPrometheusMultiTimings(t *testing.T) {
	...
	s = append(s, fmt.Sprintf("%s_%s_bucket{%s=\"%s\",%s=\"%s\",le=\"0.0016\"} %d", namespace, name, cats[0], catLabels[0], cats[1], catLabels[1], 0))
	s = append(s, fmt.Sprintf("%s_%s_bucket{%s=\"%s\",%s=\"%s\",le=\"0.0025\"} %d", namespace, name, cats[0], catLabels[0], cats[1], catLabels[1], 0))
	s = append(s, fmt.Sprintf("%s_%s_bucket{%s=\"%s\",%s=\"%s\",le=\"0.004\"} %d", namespace, name, cats[0], catLabels[0], cats[1], catLabels[1], 0))
	s = append(s, fmt.Sprintf("%s_%s_bucket{%s=\"%s\",%s=\"%s\",le=\"0.0063\"} %d", namespace, name, cats[0], catLabels[0], cats[1], catLabels[1], 0))
	s = append(s, fmt.Sprintf("%s_%s_bucket{%s=\"%s\",%s=\"%s\",le=\"0.01\"} %d", namespace, name, cats[0], catLabels[0], cats[1], catLabels[1], 0))
	s = append(s, fmt.Sprintf("%s_%s_bucket{%s=\"%s\",%s=\"%s\",le=\"0.016\"} %d", namespace, name, cats[0], catLabels[0], cats[1], catLabels[1], 0))
	s = append(s, fmt.Sprintf("%s_%s_bucket{%s=\"%s\",%s=\"%s\",le=\"0.025\"} %d", namespace, name, cats[0], catLabels[0], cats[1], catLabels[1], 0))
	s = append(s, fmt.Sprintf("%s_%s_bucket{%s=\"%s\",%s=\"%s\",le=\"0.04\"} %d", namespace, name, cats[0], catLabels[0], cats[1], catLabels[1], 1))
	s = append(s, fmt.Sprintf("%s_%s_bucket{%s=\"%s\",%s=\"%s\",le=\"0.063\"} %d", namespace, name, cats[0], catLabels[0], cats[1], catLabels[1], 1))
	s = append(s, fmt.Sprintf("%s_%s_bucket{%s=\"%s\",%s=\"%s\",le=\"0.1\"} %d", namespace, name, cats[0], catLabels[0], cats[1], catLabels[1], 1))
	s = append(s, fmt.Sprintf("%s_%s_bucket{%s=\"%s\",%s=\"%s\",le=\"0.16\"} %d", namespace, name, cats[0], catLabels[0], cats[1], catLabels[1], 1))
	s = append(s, fmt.Sprintf("%s_%s_bucket{%s=\"%s\",%s=\"%s\",le=\"0.25\"} %d", namespace, name, cats[0], catLabels[0], cats[1], catLabels[1], 2))
	s = append(s, fmt.Sprintf("%s_%s_bucket{%s=\"%s\",%s=\"%s\",le=\"0.4\"} %d", namespace, name, cats[0], catLabels[0], cats[1], catLabels[1], 2))
	s = append(s, fmt.Sprintf("%s_%s_bucket{%s=\"%s\",%s=\"%s\",le=\"0.63\"} %d", namespace, name, cats[0], catLabels[0], cats[1], catLabels[1], 2))
	s = append(s, fmt.Sprintf("%s_%s_bucket{%s=\"%s\",%s=\"%s\",le=\"1\"} %d", namespace, name, cats[0], catLabels[0], cats[1], catLabels[1], 3))
	s = append(s, fmt.Sprintf("%s_%s_bucket{%s=\"%s\",%s=\"%s\",le=\"1.6\"} %d", namespace, name, cats[0], catLabels[0], cats[1], catLabels[1], 3))
	s = append(s, fmt.Sprintf("%s_%s_bucket{%s=\"%s\",%s=\"%s\",le=\"2.5\"} %d", namespace, name, cats[0], catLabels[0], cats[1], catLabels[1], 3))
	s = append(s, fmt.Sprintf("%s_%s_bucket{%s=\"%s\",%s=\"%s\",le=\"4\"} %d", namespace, name, cats[0], catLabels[0], cats[1], catLabels[1], 3))
	s = append(s, fmt.Sprintf("%s_%s_bucket{%s=\"%s\",%s=\"%s\",le=\"6.3\"} %d", namespace, name, cats[0], catLabels[0], cats[1], catLabels[1], 3))
